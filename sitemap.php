...
foreach (['/', '/products.php', '/calculator.php', '/privacy-policy.php', '/cctv-camera-installation-dha-karachi', '/home-cctv-installation-karachi', '/office-cctv-installation-karachi', '/shop-cctv-installation-karachi'] as $path) sitemapEntry($path);
